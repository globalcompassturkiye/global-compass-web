export default {
  async fetch(request, env, ctx) {
    ...
    const expiredPaths = [
      ...
      "/ingiltere-yaz-okullari/immerse-education-cambridge-yaz-okulu/film-studies",
      "/ingiltere-yaz-okullari/immerse-education-oxford-yaz-okulu-1-1",
      "/ingiltere-yaz-okullari/immerse-education-cambridge-yaz-okulu/psikoloji",
      "/ingiltere-yaz-okullari/immerse-education-13-15-yas/psikoloji",
      "/general-clean",
      "/yaz-okulları",
      "/londra-yaz-okulları",
      "/kvkk",
